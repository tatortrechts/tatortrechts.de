...
function Karte({
  ...
  const description =
    "13 Projekte haben seit 2000 über 16.000 Fälle mit rechtem Bezug registriert. Wir zeigen sie auf einer interaktiven Karte. Ein Projekt von Anna Neifer und Johannes Filter.";
  return (
    <>
      <Head>
        <title>{title}</title>
